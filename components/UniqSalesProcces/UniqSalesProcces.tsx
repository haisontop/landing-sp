  ...
  return (
    <section>
      <div className='container mx-auto px-4'>
          ...
          <div className='mt-20 lg:w-10/12 mx-auto grid gap-x-2 lg:gap-x-0 lg:gap-y-4 grid-flow-col lg:grid-flow-row lg:grid-cols-1 auto-cols-[370px] lg:auto-cols-auto overflow-x-auto scrollbar-hide'>
            <StepOne />
            <StepTwo />
            <StepThree />
          </div>
