  ...
  const data = [
    {
      ...
      description:
        "This post will explore the advantages of purchasing a home in a suburban area, including access to good schools, lower crime rates, and more green space…",
    },
    {
      id: 2,
      ...
      description:
        "This post will explore the potential benefits and drawbacks of purchasing a fixer-upper property, including the potential for equity growth and the…",
    },
    {
      id: 3,
      ...
      description:
        "This post will discuss key factors to consider when selecting a location for your next home, such as proximity to schools, work, and amenities…",
    },
  ];
  return (
    <>
      ...
      <Button
        label="View more knowledge articles"
        type="blue"
        className="mt-6 mx-auto  justify-center lg:hidden"
      />
    </>
  );
};
