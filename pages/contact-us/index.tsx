          ...
          <div className=" rounded-2xl px-7 lg:px-16 pt-14 pb-10 bg-sp-pink border border-sp-solid-pink-600">
            ...
            <form onSubmit={formik.handleSubmit} className="mt-10 text-sp-solid-gray-800">
              ...
              <input
                ...
                type="text"
                className={`text-base p-4 border ${formik.errors.name ? 'border-red-800' : 'border-sp-solid-pink-600'} rounded-lg mt-3 w-full lg:w-2/3`}
              />
              <div className="mt-8" />
              <label className="text-lg font-medium">
              ...
              <input
                ...
                type="text"
                className={`text-base p-4 border ${formik.errors.email ? 'border-red-800' : 'border-sp-solid-pink-600'} rounded-lg mt-3 w-full lg:w-3/4`}
              />
              <div className="mt-8" />
              <label className="text-lg font-medium">
              ...
              <input
                ...
                type="text"
                className={`text-base p-4 border ${formik.errors.phone ? 'border-red-800' : 'border-sp-solid-pink-600'} rounded-lg mt-3 w-full lg:w-auto `}
              />
              <div className="mt-8" />
              ...
              <textarea
                ...
                className={`text-base p-4 border ${formik.errors.message ? 'border-red-800' : 'border-sp-solid-pink-600'} rounded-lg mt-3 w-full h-[114px]`}
              />
              <Button
                type="blue"
